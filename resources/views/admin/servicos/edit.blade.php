                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control @error('data') is-invalid @enderror " id="data" name="data" value="{{ $servico->horaInicial->format('dd-mm-aaaa') }}" placeholder="Horário de início:">
                                        @error('data')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
